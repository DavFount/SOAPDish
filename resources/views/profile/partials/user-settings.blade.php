<section class="space-y-6">
    ...
    <div>
        <button id="themeSwitcher" type="button" onclick="switchTheme();" class="bg-gray-900 text-gray-100 hover:bg-gray-800 hover:border hover:border-gray-900 dark:bg-100 dark:text-gray-100 p-2 text-xs rounded-xl custom-shadow"></button>
        <button type="button" onclick="resetTheme()" class="ml-3 bg-gray-900 text-gray-100 hover:bg-gray-800 hover:border hover:border-gray-900 dark:bg-100 dark:text-gray-100 p-2 text-xs rounded-xl custom-shadow">Reset to Default</button>
    </div>
</section>
